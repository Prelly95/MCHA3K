...
TEST(Ctrl, OneStepAx)
{
    ...
    float x_expected[CTRL_N_STATE] = {0.099946, 0.015962};
...
TEST(Ctrl, OneStepBu)
{
    ...
    float x_expected[CTRL_N_STATE] = {0.000168, 3.792605};
    TEST_ASSERT_EQUAL_FLOAT_ARRAY(x_expected, x_actual, CTRL_N_STATE);
}
...
TEST(Ctrl, RunSteps)
{
    ...
    float y_expected[][CTRL_N_OUTPUT] = {{0.1}, {3.808567}, {8.658447}, {15.00273}, {23.303738}};
